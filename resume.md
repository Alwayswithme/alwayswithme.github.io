...
*   **深圳市傲冠软件股份有限公司**
 ...
    *开发工程师*， 2014年7月 ~ 至今，参与三个项目的研发和改进
    ...
    -   行云服务•云运维
        ...
        用到 SpringMVC 设计 RESTful API，并完善相关缺失文档。参与优化 MySQL 数据库，通 过减少 JDBC 与数据库交互，改进 SQL 慢查询语句，针对全表扫描过多的表添加所需索引等 手段，减轻服务器数据库压力和提高响应速度。还参与了涉及网络编程的行云网关模块，实现协议编解码，心跳与超时处理，加密压缩等功能。还负责了此项目的微信公众号中一部分后台功能的开发。
